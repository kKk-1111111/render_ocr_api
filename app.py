...
OCR_ENABLE_ENGINE_FALLBACK = os.getenv("OCR_ENABLE_ENGINE_FALLBACK", "false").lower() in (
    "1",
    "true",
    "yes",
)
MAX_CONSECUTIVE_OCR_FAILURES = int(os.getenv("MAX_CONSECUTIVE_OCR_FAILURES", "8"))
CORS_ALLOW_ORIGINS = [
    origin.strip()
